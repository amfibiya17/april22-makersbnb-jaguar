...
describe Booking do
  describe '.check' do
    it 'can check a booking with a home and a date and return true' do
    ...
    it 'can check a booking with a home and a date and return false' do
      home_name = 'Waterloo 25'
      ...
      expect(Booking.check(home, unavailable_night)).to eq false
    end
  end
end
